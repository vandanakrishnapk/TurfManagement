...
{
    $turfid = $_SESSION['turfid'];
$sql = mysqli_query($conn,"SELECT * FROM turf_registration WHERE turf_id ='$turfid'");
          ...
          <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">   
            ...
            <div class="card" style="width:500px">
              ...
              <div class="form-group">
                ...
                <form method="POST">
                    <input type="text" name="amount" value="<?php $data['cost'];?>"><br>
                    <input type="radio" name="payment_status" placeholder="payment_status" value="paid">paid <br>
                    <input type="radio" name="payment_status" placeholder="payment_status" value="unpaid">unpaid
                </form>
              </div>
